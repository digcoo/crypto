...
//@Slf4j
//@Component
//public class MacdGoldBackCrossStrategy implements TradeStrategy {
//
//    @Override
...
//
//        SignalType signalType = SimpleSignalTool.checkBackCrossGoldSignal(candlestick0, candlestick1, macdPoints);
