...
//@Component
//@Slf4j
//public class MacdOverRiseStrategy implements TradeStrategy {
//
//
//    @Override
...
//
//            SignalType signalType = SimpleSignalTool.checkRiseOverMacdSignal(candlestick0, candlestick1, macdPoints);
...
//
//        }catch (Exception ex) {
//            log.error("error MacdOverRiseStrategy, symbol: {}, period: {}", symbol, period, ex);
//        }
//
//
//        return Signal.NO_SIGNAL;
