...
// */
//@Component
//public class MacdGoldFallStrategy implements TradeStrategy {
//
//    public MacdGoldFallStrategy() {
//    }
//
//    @Override
...
//
//        //分析当前信号
//        SignalType signalType = StrategyTool.checkFallMacdGoldSignal(candlesticks, macdPoints);
//
