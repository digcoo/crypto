...
// */
//@Component
//public class MacdTurnRoundStrategy implements TradeStrategy {
//
//    @Override
//    public StrategyType getStrategyType() {
//        return StrategyType.MACD_OVER_TURN_ROUND;
//    }
//
//    @Override
...
//
//        SignalType signalType = SimpleSignalTool.checkTurnRoundMacdSignal(macdPoints);
//        if (SignalType.NO_SIGNAL == signalType) {
//            return Signal.NO_SIGNAL;
//        }
//
//        long triggerTime = System.currentTimeMillis();
//        if (SignalType.BUY == signalType && checkBuyTrend(candlesticks)) {
...
//                    .build();
//        } else if (SignalType.SELL == signalType && checkSellTrend(candlesticks)) {
