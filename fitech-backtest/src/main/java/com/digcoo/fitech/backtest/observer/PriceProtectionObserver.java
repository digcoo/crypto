...
///**
// *
// * 1、价格保护触发(提前止盈) -> 市价止盈下单
// *
// */
//@Slf4j
//@Component
//public class PriceProtectionObserver implements CandlestickObserver {
...
//
//    public PriceProtectionObserver(PortfolioModule portfolio, OrderExecutionModule orderExecutor, Config config, INoGenerator noGenerator) {
